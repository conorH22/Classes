...
void EnemyScene::addEnemyGhoul(float dt)
{
	...
	auto move_ease_in = EaseBounceInOut::create(actionMove->clone());
...
void EnemyScene::addEnemyRaider(float st)
{
	...
	// create a BounceIn Ease Action
	auto move_ease_in =EaseExponentialInOut::create(actionMove->clone());
...
void EnemyScene::addEnemyRobot(float xt)
{
	...
	// create a BounceIn Ease Action
	auto move_ease_in = EaseElasticInOut::create(actionMove->clone());
